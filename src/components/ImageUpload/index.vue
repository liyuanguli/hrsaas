...
const cos = new COS({
  SecretId: 'AKID1qPhiSo43lJcfRwA7pGm1ziCQM0NXPzH', // 身份识别 ID
  SecretKey: 'wb1A1asuiETR7Uw82g25rLs74oHSLzLP' // 身份密钥
})
export default {
  name: '',
  ...
  methods: {
    ...
    upload(params) {
      if (params.file) {
        // 执行上传操作
        cos.putObject({
          Bucket: 'liyuan-1-1313001093', // 存储桶
